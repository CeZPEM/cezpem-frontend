    ...
    <div className="flex justify-center">
      <label htmlFor={randomId} className="relative w-full max-w-2xl">
        ...
        <input
          ...
          className="w-full font-archivo text-20px pl-10 pr-3 py-2 rounded-lg bg-white text-gray-900 border border-gray-200 focus:ring-2 focus:ring-darkOrange outline-none shadow-sm"
        />
      </label>
    </div>
  );
